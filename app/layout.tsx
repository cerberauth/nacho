      ...
      <body className={`min-h-[100dvh] bg-white dark:bg-gray-950 text-black dark:text-white ${fontSans.className} antialiased`}>
        ...
        <footer className="text-center p-8 space-y-4">
          <p className="text-gray-500 text-sm">
            <Link className="text-primary" href="/clients">Clients</Link> - <Link className="text-primary" href="/templates">Templates</Link> - <Link className="text-primary" href="/use-cases">Use Cases</Link> - <Link className="text-primary" href="/iam/providers">(C)IAM Providers Benchmark</Link> - <Link className="text-primary" href="/openid/providers">OpenID Connect Providers Benchmark</Link>
          </p>
          <p className="text-sm">
